    ...
    <el-row>
      <el-col :span="12">
        <div class="speed-limit">
          ...
          <p class="speed-limit-content">{{ transferInfoStore.infoState.globalInfo }}
            {{ transferInfoStore.infoState.globalInfo.dl_info_speed.getSizeUnit() }}</p>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="speed-limit">
          <p class="speed-limit-header">Upload Speed</p>
          <p class="speed-limit-content">{{ transferInfoStore.infoState.globalInfo.up_info_speed.getSize() }}
            {{ transferInfoStore.infoState.globalInfo.up_info_speed.getSizeUnit() }}</p>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="12">
        <div class="speed-limit">
          ...
          <p class="speed-limit-content">{{ transferInfoStore.infoState.globalInfo.dl_info_data.getSize() }}
            {{ transferInfoStore.infoState.globalInfo.dl_info_data.getSizeUnit() }}</p>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="speed-limit">
          ...
          <p class="speed-limit-content">{{ transferInfoStore.infoState.globalInfo.dl_info_data.getSize() }}
            {{ transferInfoStore.infoState.globalInfo.up_info_data.getSizeUnit() }}</p>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="12">
        <div class="speed-limit">
          ...
          <p class="speed-limit-content">{{ transferInfoStore.infoState.globalInfo.dht_nodes }}</p>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="speed-limit">
          <p class="speed-limit-header">Speed Limit</p>
          <el-switch v-model="transferInfoStore.infoState.globalInfo.dht_nodes"/>&nbsp;
          <el-icon>
            <Setting/>
          </el-icon>
        </div>
...
//transferInfoStore.setIntervalId(intervalId)
